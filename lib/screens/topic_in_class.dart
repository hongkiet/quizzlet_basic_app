...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: List_Topic_InClass(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class List_Topic_InClass extends StatefulWidget {
  final String? data;
  final String? id_class;

  const List_Topic_InClass({Key? key, this.data, this.id_class}) : super(key: key);

  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<List_Topic_InClass> {
